...
class ConversionForm extends StatefulHookConsumerWidget {
  ...
  @override
  ConsumerState<ConversionForm> createState() => _ConversionFormState();
}

class _ConversionFormState extends ConsumerState<ConversionForm> {
